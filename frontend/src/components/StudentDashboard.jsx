...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    axios
      .get("https://5000-idx-gdg-doordie-1743806459319.cluster-iktsryn7xnhpexlu6255bftka4.cloudworkstations.dev/api/assignments/")
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://5000-idx-gdg-doordie-1743806459319.cluster-iktsryn7xnhpexlu6255bftka4.cloudworkstations.dev/api/upload-assignment",
        formData
      );
